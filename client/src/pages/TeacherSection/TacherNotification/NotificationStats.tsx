      ...
      <Card className="hover:shadow-md transition-shadow">
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <div className="text-xl sm:text-2xl font-bold text-red-600">{overdueTasks}</div>
              <div className="text-xs sm:text-sm text-gray-600">Overdue Tasks</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="hover:shadow-md transition-shadow">
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <div className="text-xl sm:text-2xl font-bold text-yellow-600">{urgentReminders}</div>
              <div className="text-xs sm:text-sm text-gray-600">Urgent Reminders</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="hover:shadow-md transition-shadow">
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <div className="text-xl sm:text-2xl font-bold text-blue-600">{unreadMessages}</div>
              <div className="text-xs sm:text-sm text-gray-600">Unread Messages</div>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="hover:shadow-md transition-shadow">
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              <div className="text-xl sm:text-2xl font-bold text-purple-600">{highPriorityItems}</div>
